...
Автомаматическое формирование меток позволяет формивать иерархию меток в соответствии со справочником и автоматически присвоить метки соответствующим линиям по справочнику , так же задать нужный цвет в соответствии с выбранным типом линии и так же для групп сопособа прокладки линии формируется отдельный блок меток в соответствии со способом прокладки
- Создать необходимые линии
- Заполнить справочник меток
- В меню метки выбрать пункт обновить метки
![Пример указания способа прокладки](https://github.com/lvm444/skpelectrics/blob/main/tags_example.png).
